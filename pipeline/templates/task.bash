...
{% if AnalysisType == "single" or bulk_like and Organism == "Mus musculus" and cell_ranger and not test_mode %}
...
{% elif AnalysisType == "single" or bulk_like and Organism == "Mus musculus" and not cell_ranger and not test_mode %}
...
{% elif AnalysisType == "single" or bulk_like and Organism == "Homo sapiens" and cell_ranger and not test_mode %}
...
{% elif AnalysisType == "single" or bulk_like  and Organism == "Homo sapiens" and not cell_ranger and not test_mode %}
...
{% elif AnalysisType == "single" or bulk_like and Organism == "Rattus norvegicus" and cell_ranger and not test_mode %}
...
{% elif AnalysisType == "single" or bulk_like and Organism == "Rattus norvegicus" and not cell_ranger and not test_mode %}
