...
snakemake -j {{ Threads }} --use-singularity --use-conda --conda-prefix {{ PathToCondaDir }} --singularity-prefix {{ PathToSingularityDir }} --singularity-args '--bind {{ CondaFull }}:{{ CondaFull }}' --verbose
{% elif test_mode %}
